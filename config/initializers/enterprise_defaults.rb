# config/initializers/enterprise_defaults.rb

# frozen_string_literal: true

# Adicionamos uma verificação para não executar este código durante a precompilação de assets.
# A variável de ambiente 'RAILS_GROUPS' é definida como 'assets' durante o 'assets:precompile'.
# Isso evita a tentativa de conexão com o banco de dados durante o 'docker build'.
if defined?(Rails::Server) || !(ENV['RAILS_GROUPS'] == 'assets')
